...
const ErrorPage = () => {
  return (
    <>
      <section className="relative z-10 py-16 xs:pb-[80px] xs:pt-[110px] sm:pb-[100px] sm:pt-[120px] md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[160px] 2xl:pt-[150px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                ...
                <h3 className="mb-4 text-3xl font-bold text-secondary-foreground dark:text-secondary-foreground sm:text-4xl">
                  Sorry, the page can’t be found
                </h3>
                <p className="mb-10 text-base font-medium leading-relaxed text-muted-foreground dark:text-muted-foreground sm:text-lg sm:leading-relaxed">
                  The page you were looking for appears to have been moved,
                  deleted or does not exist.
                </p>
                <Link
                  href="/"
                  className="rounded-md bg-primary px-8 py-3 text-base font-bold text-primary-foreground duration-300 hover:bg-primary/[90%] dark:bg-primary dark:text-primary-foreground dark:hover:bg-primary/[90%] md:px-9 lg:px-8 xl:px-9"
                >
                  Back to Homepage
                </Link>
              </div>
