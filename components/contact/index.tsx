import NewsLatterBox from "@/components/contact/news-latter-box"

const Contact = () => {
  return (
    <section
      id="contact"
      className="overflow-hidden bg-background py-16 dark:bg-background xs:pb-[80px] xs:pt-[110px] sm:pb-[100px] sm:pt-[120px] md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[160px] 2xl:pt-[150px]"
    >
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="relative w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="mb-12 rounded-md bg-primary/[.03] dark:bg-primary/[.03] px-8 py-11 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
              <h2 className="mb-3 text-2xl font-bold text-secondary-foreground dark:text-secondary-foreground sm:text-3xl lg:text-2xl xl:text-3xl">
                Need Help? Open a Ticket
              </h2>
              <p className="mb-12 text-base font-medium text-muted-foreground dark:text-muted-foreground">
                ...
                <div className="-mx-4 flex flex-wrap">
                  <div className="w-full px-4 md:w-1/2">
                    <div className="mb-8">
                      <label
                        htmlFor="name"
                        className="mb-3 block text-sm font-medium text-secondary-foreground dark:text-secondary-foreground"
                      >
                        Your Name
                      </label>
                      <input
                  ...
                  <div className="w-full px-4">
                    <button className="outline-non mb-4 w-full cursor-pointer rounded-md border border-transparent bg-primary px-6 py-3 text-center text-base font-medium text-primary-foreground hover:opacity-90 dark:bg-primary dark:text-primary-foreground">
                      Submit Ticket
                    </button>
                  </div>
                </div>
